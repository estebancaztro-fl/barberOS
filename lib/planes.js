...
export const INCLUYE = [
  "Agenda con horarios y bloqueos",
  "Link de reservas online para tus clientes",
  "Visagismo Scan: análisis de rostro sin subir la foto",
  "Ficha de cliente con historial y fotos de cada corte",
  "Finanzas, comisiones y CRM",
  "Hasta 4 barberos atendiendo",
];
